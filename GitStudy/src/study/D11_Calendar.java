...
public class D11_Calendar {
	...
	public static void main(String[] args) {
		...
		int month = korea.get(Calendar.MONTH); // Calendar 클래스는 month 만 0으로 시작한다
		...
		// Calendar.AM_PM이 필드 상수이고, Calendar.AM과 Calendar.PM 은 상수이다
		...
		System.out.println("DAY(올해가 시작되고 지난 날짜 :" + doy);
		System.out.println("DOM(이번 달 시작되고 지난 날짜) : " + dom);
		System.out.println("DOW(이번 주 시작되고 지난 날짜, 요일) : " + dow);
		System.out.println("DOWIN(이번 달의 몇번째 해당 요일인가) : " + dowim);
		...
		System.out.println("Calendar.WEDNEDAY : " + Calendar.WEDNESDAY);
		...
		System.out.println("한국 연도 : " + year);
		System.out.println("한국 달 : " + month + 1);
		System.out.println("한국 일 : " + date);
