...
public class B18_Array2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("num1[0] (실제 위치 : [I@53bd815b): " + num1[0]);
		System.out.println("num1[1] (실제 위치 : [I@53bd815f): " + num1[1]);
		System.out.println("num1[2] (실제 위치 : [I@53bd8152): " + num1[2]);

		
		// 2차원 배열의 값 사용하기
		System.out.println(arr2[0][5]);//0, 5
		System.out.println(arr2[1][1]);// 1, 8
		System.out.println(arr2[2][2]);//2,4
		
		// n차원 배열은 n중 반복문으로 모두 탐색 할 수 있다
