...
public class D01_ArrayList {
			...
			/*
			 		# Java Collections
			 			...
			 			- Collections 인터페이스를 상속받은 인터페이스로는 List, Set 이 있다
			 			
			 		# java.util.ArrayList
			 		
			 			- 배열과 다르게 크기가 자동으로 조절되는 자료구조 클래스
			 			- 배열과 유사한 형태이다
			 			- 순차적으로 데이터에 접근할 떄 가장 유리하다
		...
		public static void main(String[] args) {
			...
			//		- 제네릭에는 기본형 타입을 사용할 수 없다 (기본 타입의 WrapperClass 이용) 다음에 배움
			ArrayList<String> fruits = new ArrayList<>();
			ArrayList<Integer> numbers = new ArrayList<>(); // int 안됨
			...
			// remove(index) : 해당 번째의 데이터를 삭제한다. 방금 지운 데이터를 반환한
			...
			System.out.println("strowberry를 성공적으로 삭제했습니다");
			}else {
				System.out.println("strowberry가 없어서 삭제하지 못했습니다");
			}
