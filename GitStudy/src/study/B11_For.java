	...
	public static void main(String[] args) {
		...
		/*
		 		 # 반복문 (Loop)
		 		 	...
		 		 	- 똑같은 코드를 여러번 반복하고 싶을 떄 사용한다
		 		 	
		 	
		 		 for (초기화자리; 조건; 증가값) {
		 				가운데 있는 조건이 true 인 동안 반복될 명령어들을 적는 곳
		 		 }
		 */
		...
		//	-반복문은 원하는 타이밍에 break 문을 통해 탈출할 수 있다
		int count = 0;
		...
		for( ; ; ) {
			...
			// 연습문제 : continue를 이용하여 5천부터 100 사이에 존재하는 홀수만 출력해보세요
			for (int i = 5000; i >=100; --i) { // i-- 해도 비슷함 상황에 따라 다를듯
				
			
				if(i % 2 == 0) {
					continue; // 짝수일 떄는 continue를 만나기 떄문에 출력 X
				}
			System.out.println(i);					
			}
			//짝수 출력 
