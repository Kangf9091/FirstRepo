...
public class A04_VarNaming {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	(1) 두 단어 이상을 이어 붙인 변수명을 사용할 때 _를 활용한다  (snake_case)
		 		ex: apple_count, minsu_age ... grade
		 	(2) 두 단어 이상을 이어붙인 변수명을 사용할 떄 대문자를 활용한다 (camelCase)
		 		ex: appleCount, minsuAge, .. Grede
		 	...
		 	(6) 변수에 들어 있는 값을 추측할 수 있는 적절한 단어를 사용하자
