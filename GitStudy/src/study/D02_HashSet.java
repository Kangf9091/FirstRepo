...
public class D02_HashSet {
		...
		/*
		 		...
		 		# Hash
		 			...
		 			-	어떤 값을 넣었을 때 전혀 예측을 할 수 없는 값이 생성되어야 하는 알고리즘
	...
	public static void main(String[] args) {
			...
			System.out.println(english); // 뭐가 이래서 다형성다형성해?
			...
			//  - List 의 내용들 중 중복을 제거한 목록이 필요하다면 Set으로 변환하여 사용할 수 있다
			...
			System.out.println("배열로 전환된 english : " + Arrays.toString(arr2));
			
			
			
			// 제네릭을 요구하는 클래스에 제네릭을 사용하지 않는 경우 모든 타입을 넣을 수 있다
			//		- 모든 타입으 Object 타입으로 업캐스팅 되어 저장된다
			...
			System.out.println("english 에는 subset의 모든 내용이 들어있나요? " 
											+ english.containsAll(subset));
			System.out.println("english 에는 sublist의 모든 내용이 들어있나요? " 
					+ english.containsAll(sublist));
			
			// addAll(Collection) : 전달한 컬렉의 내용을 모두 추가 (추가 성공 여부를 반환)
			//		- 새로 추가된 것이 있으면 true
			...
			// # isEmpty() : 해당 컬렉션이 비어있으면 true       여기 설명 다시 들어야됨
